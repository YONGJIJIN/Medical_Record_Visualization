...
app.get('/history/type=:type/position=:id',function(req,res){
	var getAllHistory = "select * from history where patient_id = " + req.cookies.patientId;
	var init ="";
	var postArray = [];
